...
ipx::associate_bus_interfaces -busif raw_packet -clock ap_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif decoded_packet -clock ap_clk [ipx::current_core]
