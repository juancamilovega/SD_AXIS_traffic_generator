...
ipx::associate_bus_interfaces -busif from_app -clock ap_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif from_cmp_fifo -clock ap_clk [ipx::current_core]
