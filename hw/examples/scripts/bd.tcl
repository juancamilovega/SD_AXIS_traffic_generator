...
proc create_hier_cell_software { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S_AXI_LITE1_1 [get_bd_intf_pins AXIDMAs/S_AXI_LITE1] [get_bd_intf_pins axi_interconnect_0/M02_AXI]
  connect_bd_intf_net -intf_net S_AXI_LITE_1 [get_bd_intf_pins AXIDMAs/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  ...
  connect_bd_net -net AXIDMAs_interconnect_aresetn [get_bd_pins interconnect_aresetn] [get_bd_pins AXIDMAs/interconnect_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins debug_bridge_0/s_axi_aresetn]
  connect_bd_net -net M03_ACLK_1 [get_bd_pins M03_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK]
  connect_bd_net -net M03_ARESETN_1 [get_bd_pins M03_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins pl_clk0] [get_bd_pins AXIDMAs/slowest_sync_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins debug_bridge_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins AXIDMAs/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: fake_app
proc create_hier_cell_fake_app { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_fake_app() - Empty argument(s)!"}
     return
  }
  ...
  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins axis_register_slice_4/aclk] [get_bd_pins axis_register_slice_5/aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins axis_register_slice_4/aresetn] [get_bd_pins axis_register_slice_5/aresetn]
...
proc create_root_design { parentCell } {
  ...
  set axis_data_fifo_0 [ addip axis_data_fifo axis_data_fifo_0 ]
  set_property -dict [ list \
   CONFIG.FIFO_DEPTH {64} \
 ] $axis_data_fifo_0

  # Create instance: fake_app
  create_hier_cell_fake_app [current_bd_instance .] fake_app
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net C0_SYS_CLK_0_1 [get_bd_intf_ports C0_SYS_CLK_0] [get_bd_intf_pins DDR/C0_SYS_CLK_0]
  connect_bd_intf_net -intf_net DDR_C0_DDR4_0 [get_bd_intf_ports C0_DDR4_0] [get_bd_intf_pins DDR/C0_DDR4_0]
  ...
  connect_bd_intf_net -intf_net SD_AXIS_traffic_gen_0_to_app [get_bd_intf_pins SD_AXIS_traffic_gen_0/to_app] [get_bd_intf_pins fake_app/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets SD_AXIS_traffic_gen_0_to_app] [get_bd_intf_pins fake_app/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net SD_AXIS_traffic_gen_0_to_cmp_fifo [get_bd_intf_pins SD_AXIS_traffic_gen_0/to_cmp_fifo] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  connect_bd_intf_net -intf_net SD_AXIS_traffic_gen_0_to_ddr [get_bd_intf_pins SD_AXIS_traffic_gen_0/to_ddr] [get_bd_intf_pins axi_interconnect_2/S02_AXI]
connect_bd_intf_net -intf_net SD_AXIS_traffic_gen_0_user_SD_AXIS_dbg [get_bd_intf_pins SD_AXIS_traffic_gen_0/user_SD_AXIS_dbg] [get_bd_intf_pins system_ila_0/SLOT_2_SD_AXIS_DBG]
  connect_bd_intf_net -intf_net axi_interconnect_2_M00_AXI [get_bd_intf_pins DDR/C0_DDR4_S_AXI] [get_bd_intf_pins axi_interconnect_2/M00_AXI]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins SD_AXIS_traffic_gen_0/from_cmp_fifo] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  connect_bd_intf_net -intf_net fake_app_M_AXIS [get_bd_intf_pins SD_AXIS_traffic_gen_0/from_app] [get_bd_intf_pins fake_app/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets fake_app_M_AXIS] [get_bd_intf_pins fake_app/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  connect_bd_intf_net -intf_net software_M03_AXI [get_bd_intf_pins SD_AXIS_traffic_gen_0/s_axilite_ctrl] [get_bd_intf_pins software/M03_AXI]

  # Create port connections
  connect_bd_net -net DDR_peripheral_reset [get_bd_pins DDR/peripheral_reset] [get_bd_pins SD_AXIS_traffic_gen_0/rst]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins DDR/interconnect_aresetn] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S02_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins fake_app/aresetn] [get_bd_pins software/M03_ARESETN]
  ...
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins DDR/c0_ddr4_ui_clk] [get_bd_pins SD_AXIS_traffic_gen_0/ddr_clk] [get_bd_pins SD_AXIS_traffic_gen_0/traffic_clk] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S02_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins fake_app/aclk] [get_bd_pins software/M03_ACLK] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins system_ila_0/resetn] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_2/S01_ACLK] [get_bd_pins software/pl_clk0]

  # Create address segments
  create_bd_addr_seg -range 0x000400000000 -offset 0x00000000 [get_bd_addr_spaces SD_AXIS_traffic_gen_0/to_ddr] [get_bd_addr_segs DDR/ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] SEG_ddr4_0_C0_DDR4_ADDRESS_BLOCK
  create_bd_addr_seg -range 0x00010000 -offset 0xA0030000 [get_bd_addr_spaces software/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SD_AXIS_traffic_gen_0/s_axilite_ctrl/reg0] SEG_SD_AXIS_traffic_gen_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces software/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs software/AXIDMAs/axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0020000 [get_bd_addr_spaces software/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs software/AXIDMAs/axi_dma_1/S_AXI_LITE/Reg] SEG_axi_dma_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces software/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs software/debug_bridge_0/S_AXI/Reg0] SEG_debug_bridge_0_Reg0
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_SG] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HP0_DDR_HIGH
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_MM2S] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HP0_DDR_HIGH
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_S2MM] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HP0_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_SG] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_MM2S] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_S2MM] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_SG] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_MM2S] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_S2MM] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_SG] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] SEG_zynq_ultra_ps_e_0_HP0_QSPI
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_MM2S] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] SEG_zynq_ultra_ps_e_0_HP0_QSPI
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_0/Data_S2MM] [get_bd_addr_segs software/zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] SEG_zynq_ultra_ps_e_0_HP0_QSPI
  create_bd_addr_seg -range 0x000400000000 -offset 0x00000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_1/Data_MM2S] [get_bd_addr_segs DDR/ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] SEG_ddr4_0_C0_DDR4_ADDRESS_BLOCK
  create_bd_addr_seg -range 0x000400000000 -offset 0x00000000 [get_bd_addr_spaces software/AXIDMAs/axi_dma_1/Data_S2MM] [get_bd_addr_segs DDR/ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] SEG_ddr4_0_C0_DDR4_ADDRESS_BLOCK
