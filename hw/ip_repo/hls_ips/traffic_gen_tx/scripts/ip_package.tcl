...
ipx::associate_bus_interfaces -busif from_decoder -clock ap_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_app -clock ap_clk [ipx::current_core]
ipx::associate_bus_interfaces -busif to_cmp_fifo -clock ap_clk [ipx::current_core]
