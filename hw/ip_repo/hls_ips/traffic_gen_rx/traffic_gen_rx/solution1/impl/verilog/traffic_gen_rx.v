...
module traffic_gen_rx (
        ...
        from_app_tvalid_V,
        from_app_tready_V,
        from_cmp_fifo_tdata_V,
        from_cmp_fifo_tkeep_V,
        from_cmp_fifo_tlast_V,
        from_cmp_fifo_tvalid_V,
        from_cmp_fifo_tready_V,
        time_cnt_V,
        mismatch_V,
        rx_timeElapse_V,
        rx_timestamp_sum_V,
...
input   ap_clk;
input   ap_rst;
input  [511:0] from_app_tdata_V;
input  [63:0] from_app_tkeep_V;
input  [0:0] from_app_tlast_V;
input  [0:0] from_app_tvalid_V;
output  [0:0] from_app_tready_V;
input  [511:0] from_cmp_fifo_tdata_V;
input  [63:0] from_cmp_fifo_tkeep_V;
input  [0:0] from_cmp_fifo_tlast_V;
input  [0:0] from_cmp_fifo_tvalid_V;
output  [0:0] from_cmp_fifo_tready_V;
input  [31:0] time_cnt_V;
output  [0:0] mismatch_V;
output  [31:0] rx_timeElapse_V;
output  [63:0] rx_timestamp_sum_V;
output  [31:0] pkt_cnt_rx_V;

reg   [31:0] rx_timeElapse_reg_V;
reg   [63:0] rx_timestamp_sum_reg;
reg   [31:0] pkt_cnt_rx_reg_V;
reg   [31:0] rx_start_V;
reg   [0:0] start_initialized_V;
reg   [0:0] mismatch_reg_V;
...
wire   [0:0] start_initialized_V_s_load_fu_373_p1;
wire   [0:0] lhs_V_read_fu_237_p2;
...
initial begin
#0 rx_timeElapse_reg_V = 32'd0;
#0 rx_timestamp_sum_reg = 64'd0;
#0 pkt_cnt_rx_reg_V = 32'd0;
#0 rx_start_V = 32'd0;
#0 start_initialized_V = 1'd0;
#0 mismatch_reg_V = 1'd0;
#0 ap_CS_fsm = 1'd1;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state1) & (((((lhs_V_read_fu_237_p2 == 1'd1) & (icmp_ln883_1_fu_1560_p2 == 1'd0)) | ((xor_ln883_1_fu_1566_p2 == 1'd1) & (lhs_V_read_fu_237_p2 == 1'd1))) | ((lhs_V_read_fu_237_p2 == 1'd1) & (icmp_ln883_fu_1554_p2 == 1'd0))) | ((lhs_V_read_fu_237_p2 == 1'd1) & (from_cmp_fifo_tvalid_read_fu_278_p2 == 1'd0))))) begin
            mismatch_reg_V <= 1'd1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        pkt_cnt_rx_reg_V <= 32'd0;
    end else begin
        if (((ret_V_fu_323_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((start_initialized_V_s_load_fu_373_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((lhs_V_read_fu_237_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln700_1_fu_361_p2 = (pkt_cnt_rx_reg_V + 32'd1);
...
assign from_app_tready_V = 1'd1;

assign from_cmp_fifo_tready_V = from_app_tvalid_V;

assign from_cmp_fifo_tvalid_read_fu_278_p2 = from_cmp_fifo_tvalid_V;

assign icmp_ln883_1_fu_1560_p2 = ((from_app_tkeep_V == from_cmp_fifo_tkeep_V) ? 1'b1 : 1'b0);

assign icmp_ln883_fu_1554_p2 = ((and_ln883_fu_1548_p2 == 512'd0) ? 1'b1 : 1'b0);

assign lhs_V_read_fu_237_p2 = from_app_tvalid_V;

assign mismatch_V = mismatch_reg_V;

assign p_Result_s_fu_1538_p1 = $signed(tmp_fu_1406_p65);

assign pkt_cnt_rx_V = pkt_cnt_rx_reg_V;

assign ret_V_fu_323_p2 = (from_app_tvalid_V & from_app_tlast_V);

assign rx_timeElapse_V = rx_timeElapse_reg_V;

assign rx_timestamp_sum_V = rx_timestamp_sum_reg;
...
assign start_initialized_V_s_load_fu_373_p1 = start_initialized_V;

assign sub_ln214_fu_333_p2 = (time_cnt_V - rx_start_V);

assign tmp_10_fu_534_p3 = from_cmp_fifo_tkeep_V[32'd54];

assign tmp_11_fu_550_p3 = from_cmp_fifo_tkeep_V[32'd53];

assign tmp_12_fu_566_p3 = from_cmp_fifo_tkeep_V[32'd52];

assign tmp_13_fu_582_p3 = from_cmp_fifo_tkeep_V[32'd51];

assign tmp_14_fu_598_p3 = from_cmp_fifo_tkeep_V[32'd50];

assign tmp_15_fu_614_p3 = from_cmp_fifo_tkeep_V[32'd49];

assign tmp_16_fu_630_p3 = from_cmp_fifo_tkeep_V[32'd48];

assign tmp_17_fu_646_p3 = from_cmp_fifo_tkeep_V[32'd47];

assign tmp_18_fu_662_p3 = from_cmp_fifo_tkeep_V[32'd46];

assign tmp_19_fu_678_p3 = from_cmp_fifo_tkeep_V[32'd45];

assign tmp_1_fu_398_p3 = from_cmp_fifo_tkeep_V[32'd63];

assign tmp_20_fu_694_p3 = from_cmp_fifo_tkeep_V[32'd44];

assign tmp_21_fu_710_p3 = from_cmp_fifo_tkeep_V[32'd43];

assign tmp_22_fu_726_p3 = from_cmp_fifo_tkeep_V[32'd42];

assign tmp_23_fu_742_p3 = from_cmp_fifo_tkeep_V[32'd41];

assign tmp_24_fu_758_p3 = from_cmp_fifo_tkeep_V[32'd40];

assign tmp_25_fu_774_p3 = from_cmp_fifo_tkeep_V[32'd39];

assign tmp_26_fu_790_p3 = from_cmp_fifo_tkeep_V[32'd38];

assign tmp_27_fu_806_p3 = from_cmp_fifo_tkeep_V[32'd37];

assign tmp_28_fu_822_p3 = from_cmp_fifo_tkeep_V[32'd36];

assign tmp_29_fu_838_p3 = from_cmp_fifo_tkeep_V[32'd35];

assign tmp_2_fu_406_p3 = from_cmp_fifo_tkeep_V[32'd62];

assign tmp_30_fu_854_p3 = from_cmp_fifo_tkeep_V[32'd34];

assign tmp_31_fu_870_p3 = from_cmp_fifo_tkeep_V[32'd33];

assign tmp_32_fu_886_p3 = from_cmp_fifo_tkeep_V[32'd32];

assign tmp_33_fu_902_p3 = from_cmp_fifo_tkeep_V[32'd31];

assign tmp_34_fu_918_p3 = from_cmp_fifo_tkeep_V[32'd30];

assign tmp_35_fu_934_p3 = from_cmp_fifo_tkeep_V[32'd29];

assign tmp_36_fu_950_p3 = from_cmp_fifo_tkeep_V[32'd28];

assign tmp_37_fu_966_p3 = from_cmp_fifo_tkeep_V[32'd27];

assign tmp_38_fu_982_p3 = from_cmp_fifo_tkeep_V[32'd26];

assign tmp_39_fu_998_p3 = from_cmp_fifo_tkeep_V[32'd25];

assign tmp_3_fu_422_p3 = from_cmp_fifo_tkeep_V[32'd61];

assign tmp_40_fu_1014_p3 = from_cmp_fifo_tkeep_V[32'd24];

assign tmp_41_fu_1030_p3 = from_cmp_fifo_tkeep_V[32'd23];

assign tmp_42_fu_1046_p3 = from_cmp_fifo_tkeep_V[32'd22];

assign tmp_43_fu_1062_p3 = from_cmp_fifo_tkeep_V[32'd21];

assign tmp_44_fu_1078_p3 = from_cmp_fifo_tkeep_V[32'd20];

assign tmp_45_fu_1094_p3 = from_cmp_fifo_tkeep_V[32'd19];

assign tmp_46_fu_1110_p3 = from_cmp_fifo_tkeep_V[32'd18];

assign tmp_47_fu_1126_p3 = from_cmp_fifo_tkeep_V[32'd17];

assign tmp_48_fu_1142_p3 = from_cmp_fifo_tkeep_V[32'd16];

assign tmp_49_fu_1158_p3 = from_cmp_fifo_tkeep_V[32'd15];

assign tmp_4_fu_438_p3 = from_cmp_fifo_tkeep_V[32'd60];

assign tmp_50_fu_1174_p3 = from_cmp_fifo_tkeep_V[32'd14];

assign tmp_51_fu_1190_p3 = from_cmp_fifo_tkeep_V[32'd13];

assign tmp_52_fu_1206_p3 = from_cmp_fifo_tkeep_V[32'd12];

assign tmp_53_fu_1222_p3 = from_cmp_fifo_tkeep_V[32'd11];

assign tmp_54_fu_1238_p3 = from_cmp_fifo_tkeep_V[32'd10];

assign tmp_55_fu_1254_p3 = from_cmp_fifo_tkeep_V[32'd9];

assign tmp_56_fu_1270_p3 = from_cmp_fifo_tkeep_V[32'd8];

assign tmp_57_fu_1286_p3 = from_cmp_fifo_tkeep_V[32'd7];

assign tmp_58_fu_1302_p3 = from_cmp_fifo_tkeep_V[32'd6];

assign tmp_59_fu_1318_p3 = from_cmp_fifo_tkeep_V[32'd5];

assign tmp_5_fu_454_p3 = from_cmp_fifo_tkeep_V[32'd59];

assign tmp_60_fu_1334_p3 = from_cmp_fifo_tkeep_V[32'd4];

assign tmp_61_fu_1350_p3 = from_cmp_fifo_tkeep_V[32'd3];

assign tmp_62_fu_1366_p3 = from_cmp_fifo_tkeep_V[32'd2];

assign tmp_63_fu_1382_p3 = from_cmp_fifo_tkeep_V[32'd1];

assign tmp_6_fu_470_p3 = from_cmp_fifo_tkeep_V[32'd58];

assign tmp_7_fu_486_p3 = from_cmp_fifo_tkeep_V[32'd57];

assign tmp_8_fu_502_p3 = from_cmp_fifo_tkeep_V[32'd56];

assign tmp_9_fu_518_p3 = from_cmp_fifo_tkeep_V[32'd55];
...
assign trunc_ln791_fu_394_p1 = from_cmp_fifo_tkeep_V[0:0];

assign xor_ln883_1_fu_1566_p2 = (from_cmp_fifo_tlast_V ^ from_app_tlast_V);

assign xor_ln883_fu_1542_p2 = (from_cmp_fifo_tdata_V ^ from_app_tdata_V);

assign zext_ln700_fu_345_p1 = time_cnt_V;
